...
<v-layout column justify-center v-if="form">
    <v-flex>
        ...
        <v-card class="mb-3">
            <v-toolbar card prominent>
                ...
                <v-spacer></v-spacer>
                <v-toolbar-items>
                    <v-btn flat :to="{ name: 'pig-card', params: { id: form.id }}">ดูซาวน์การ์ด</v-btn>
    ...
    <v-flex>
        <v-btn class="box-greenFX  mr-6" @click="newCycle">
            <v-icon>mdi-library-plus</v-icon>&nbsp;<h3>{{text.head}}</h3>
        </v-btn><br><br>
